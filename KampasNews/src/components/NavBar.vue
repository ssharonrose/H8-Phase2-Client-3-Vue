...
export default {
    name: "NavBar",
    methods: {
        ...mapActions(useMainStore, ['logoutHandler']),
    ...
    <nav class="border-gray-200 bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            <a href="#" class="flex items-center">
                ...
                <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Kampas News</span>
            </a>
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
                <ul
                    ...
                    <li v-if="isLogin">
                        <RouterLink @click.prevent="readBookmark" to="/bookmarks"
                            class="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent">
                            My Bookmark </RouterLink>
                    </li>
                    <li v-if="isLogin">
                        <RouterLink @click.prevent="logoutHandler" to="/"
                            class="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-blue-500 dark:bg-blue-600 md:dark:bg-transparent">
                            Logout </RouterLink>
                    </li>
                </ul>
